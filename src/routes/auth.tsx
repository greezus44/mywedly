    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <Link to="/" className="block text-center mb-12">
          <span className="font-heading text-3xl text-black">MyWedly</span>
        </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider text-gray-500 mb-1.5">Password</label>
        ...
        <p className="mt-6 text-center text-xs text-gray-400">
          ...
          <button onClick={() => { setMode(mode === "signin" ? "signup" : "signin"); setError(null); }} className="text-black underline">
