...
export default function GuestRsvp() {
  ...
  // Determine which events the guest is invited to (group assignments + overrides)
      ...
      <div className="mx-auto max-w-md">
        <div className="event-card text-center">
          ...
          <button
            ...
            className="event-btn-secondary mt-4"
          >
            Edit response
          </button>
        </div>
              ...
              <>
                <div className="flex gap-2">
                  <button
                    ...
                    className={
                      f.status === "accept" ? "event-btn-primary flex-1" : "event-btn-secondary flex-1"
                    }
                  >
                    Joyfully Accept
                  </button>
                  <button
                    ...
                    className={
                      f.status === "decline" ? "event-btn-primary flex-1" : "event-btn-secondary flex-1"
                    }
                  >
                    Regretfully Decline
                  </button>
