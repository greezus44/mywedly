...
export default function RustyRsvp() {
  ...
  return (
    <div className="max-w-md mx-auto p-6 rounded-xl" style={{ background: "var(--event-surface)", border: "2px solid var(--event-border)" }}>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex gap-3">
            <button onClick={() => setAttending(true)} className="flex-1 py-3 rounded-lg border-2 transition-colors" style={{ borderColor: attending === true ? "var(--event-primary)" : "var(--event-border)", background: attending === true ? "var(--event-primary-light)" : "transparent", color: attending === true ? "var(--event-primary)" : "var(--event-text)" }}>Joyfully Accept</button>
