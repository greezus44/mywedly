...
export default function GuestHome() {
  ...
  // Query sub-events (displayed as "Events")
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h1 className="font-event text-3xl md:text-4xl mb-2" style={{ color: "var(--event-heading)" }}>
          {event.name}
        </h1>
        {event.event_date && (
        ...
        {eventsLoading ? (
          ...
          <div className="space-y-4">
            {subEvents.map((subEvent) => (
              ...
              >
                <h3 className="font-event text-lg mb-2" style={{ color: "var(--event-heading)" }}>
                  {subEvent.name}
                </h3>
