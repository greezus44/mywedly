...
interface EventContent { welcome_html?: string; story_html?: string; details_html?: string; }
...
export default function GuestHome() {
  ...
  return (
    <div>
      {hasWelcome && <section className="guest-section"><div className="mx-auto max-w-2xl"><RichTextContent html={content.welcome_html!} /></div></section>}
      {hasStory && <section className="guest-section" style={{ backgroundColor: "var(--event-surface-alt)" }}><div className="mx-auto max-w-2xl"><RichTextContent html={content.story_html!} /></div></section>}
