...
export default function RustyCover() {
  ...
  const cssVars = themeToEventCssVars(RUSTY_THEME) as React.CSSProperties;
  ...
  return (
    <EventThemeProvider theme={null}>
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden" style={{ ...cssVars, ...bgStyle }}>
