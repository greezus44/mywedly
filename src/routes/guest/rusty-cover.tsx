...
export default function RustyCover() {
  ...
  // Rusty cover: NO date/location, transparent logo, RUSTY_THEME
  return (
    <EventThemeProvider theme={RUSTY_THEME as unknown as Json}>
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden" style={{ backgroundColor: "var(--event-bg)" }}>
