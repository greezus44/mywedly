...
export default function RustyCover() {
  ...
  // Use the event's theme if available, otherwise fall back to RUSTY_THEME
  const theme = event ? jsonToTheme(event.theme) : RUSTY_THEME;
  ...
  return (
    <EventThemeProvider initialTheme={theme}>
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
        ...
        {event.cover_image && <div className="absolute inset-0 bg-black/50" />}
