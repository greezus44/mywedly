  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8">
      <div className="max-w-2xl text-center">
        ...
        <h1 className="text-4xl font-heading font-light text-gray-900 mb-3 tracking-tight">Wedding Invitation Studio</h1>
        ...
        <div className="flex gap-3 justify-center">
          <Button size="lg" onClick={() => navigate("/login")}>Wedding Creator Login <ArrowRight className="ml-2 h-4 w-4" /></Button>
