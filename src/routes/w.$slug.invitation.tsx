  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-16 bg-parchment">
      <div className="max-w-lg">
        {parents && (
          <p className="text-sepia text-sm tracking-widest uppercase mb-8 whitespace-pre-line" style={styleFor(getStyle(content, "parents"))}>
            {parents}
          </p>
        )}
        ...
        <h2 className="text-4xl md:text-5xl font-script text-onyx mb-10">
