...
export default function EventsEditor() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err: any) => { const msg = err?.message || ""; if (msg.includes("parent_eventId") || msg.includes("column") || msg.includes("schema")) setError("Sub-events are temporarily unavailable due to a configuration issue."); else setError("Unable to create sub-event: " + msg); console.error("Sub-event creation error:", err); },
  });
