    ...
    <div className="space-y-1.5" ref={containerRef}>
      ...
      <div className="relative">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 text-sm text-gray-900 bg-white hover:bg-gray-50 transition-colors text-left"
        >
        ...
        {open && (
          <div className="absolute z-50 mt-1 bg-white rounded-xl shadow-lg border border-gray-200 p-4 w-72">
            <div className="flex items-center justify-between mb-4">
              <button type="button" onClick={prevMonth} className="p-1 rounded-lg hover:bg-gray-100 transition-colors"><ChevronLeft className="w-4 h-4" /></button>
              <span className="text-sm font-semibold text-gray-900">{MONTHS[viewMonth.getMonth()]} {viewMonth.getFullYear()}</span>
              <button type="button" onClick={nextMonth} className="p-1 rounded-lg hover:bg-gray-100 transition-colors"><ChevronRight className="w-4 h-4" /></button>
            </div>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      !isSelected && !disabled && "text-gray-700 hover:bg-gray-100",
            ...
            <div className="flex justify-between mt-3 pt-3 border-t border-gray-100">
              ...
              <button type="button" onClick={() => { const t = new Date(); handleSelect(t); }} className="text-xs text-gray-500 hover:text-gray-900">Today</button>
            </div>
          </div>
        )}
      </div>
