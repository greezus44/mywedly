  ...
  return (
    <footer className={cn("border-t border-dash-border bg-dash-surface", className)}>
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-dash-border pt-6 md:flex-row">
          <p className="text-sm text-dash-muted">
            © {year} MyWedly. All rights reserved.
          </p>
          <div className="flex gap-4">
            <a href="#" aria-label="Twitter" className="text-dash-muted hover:text-dash-text">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="#" aria-label="Instagram" className="text-dash-muted hover:text-dash-text">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="#" aria-label="Facebook" className="text-dash-muted hover:text-dash-text">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
