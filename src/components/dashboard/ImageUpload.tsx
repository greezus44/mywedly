    ...
    <div>
      ...
      {value ? (
        ...
        <div
          ...
          className="border-2 border-dashed border-onyx/20 rounded-md p-6 text-center cursor-pointer hover:border-sepia/40 transition-colors"
        >
          {uploading ? <p className="text-sepia text-sm">Uploading…</p> : (
            <>
              <ImageIcon className="w-8 h-8 text-sepia/40 mx-auto mb-2" />
              <p className="text-sepia text-sm">Click or drag to upload</p>
            </>
          )}
        </div>
      )}
