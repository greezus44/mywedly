...
export const THEME_PRESETS: { name: string; config: ThemeConfig }[] = [
  ...
  { name: "Elegant White", config: { colors: { ...DEFAULT_THEME.colors!, background: "#ffffff", backgroundLight: "#fafafa", surface: "#ffffff", text: "#1a1a1a", border: "#c0c0c0", primary: "#888888", primaryLight: "#aaaaaa", primaryDark: "#666666" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Sage Green", config: { colors: { ...DEFAULT_THEME.colors!, background: "#f0f4ec", backgroundLight: "#f7f9f3", primary: "#7a8b6f", primaryLight: "#9aab8e", primaryDark: "#5a6b4f", border: "#7a8b6f" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Dusty Blue", config: { colors: { ...DEFAULT_THEME.colors!, background: "#eef2f5", backgroundLight: "#f5f8fa", primary: "#7a9ab8", primaryLight: "#9ab4cc", primaryDark: "#5a7a98", border: "#7a9ab8" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Blush Pink", config: { colors: { ...DEFAULT_THEME.colors!, background: "#faf0f0", backgroundLight: "#fdf5f5", primary: "#c9a0a0", primaryLight: "#dab5b5", primaryDark: "#a98080", border: "#c9a0a0" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Terracotta", config: { colors: { ...DEFAULT_THEME.colors!, background: "#f5ede6", backgroundLight: "#faf5f0", primary: "#c08060", primaryLight: "#d49a7a", primaryDark: "#a06040", border: "#c08060" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Modern Black", config: { colors: { ...DEFAULT_THEME.colors!, background: "#1a1a1a", backgroundLight: "#2a2a2a", surface: "#222222", text: "#f0f0f0", textMuted: "#999999", primary: "#d4af37", primaryLight: "#e8c55c", primaryDark: "#b8973a", border: "#d4af37" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Champagne", config: { colors: { ...DEFAULT_THEME.colors!, background: "#f7f0e6", backgroundLight: "#fcf7ef", primary: "#c4a878", primaryLight: "#d8be98", primaryDark: "#a48858", border: "#c4a878" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Garden Wedding", config: { colors: { ...DEFAULT_THEME.colors!, background: "#f3f0e8", backgroundLight: "#f9f7f2", primary: "#6b8e6b", primaryLight: "#8aab8a", primaryDark: "#4b6e4b", border: "#6b8e6b" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
  { name: "Minimal Mono", config: { colors: { ...DEFAULT_THEME.colors!, background: "#fafafa", backgroundLight: "#ffffff", primary: "#1a1a1a", primaryLight: "#444444", primaryDark: "#000000", border: "#1a1a1a" }, typography: { ...DEFAULT_THEME.typography! }, ui: { ...DEFAULT_THEME.ui! } } },
];
