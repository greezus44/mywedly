    ...
    <div className="min-h-screen flex items-center justify-center bg-mist px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-onyx text-parchment py-3 text-xs uppercase tracking-widest hover:bg-ink transition-colors">
            {mode === "signin" ? "Sign In" : "Sign Up"}
          </button>
        </form>
        <button
          onClick={() => setMode(mode === "signin" ? "signup" : "signin")}
          className="w-full text-center text-sepia text-sm mt-4 hover:text-onyx"
        >
