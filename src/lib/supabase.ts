...
export type GuestEvent = {
  id: string; wedding_id: string; name: string; kind: string; starts_at: string;
  venue_name: string | null; venue_address: string | null; dress_code: string | null;
  notes: string | null; visibility: string; sort_order: number; created_at: string;
};

export type Guest = {
  id: string; wedding_id: string; full_name: string; email: string | null;
  phone: string | null; group_label: string | null; tag: string | null;
  plus_one_allowed: boolean; address: string | null; notes: string | null;
  invite_code: string | null; group_id: string | null; username: string | null;
  created_at: string;
};
...
export type GuestSession = { guestId: string; weddingId: string; fullName: string };
