...
export interface EventContent { story?: string; story_image?: string; invitation_title?: string; invitation_subtitle?: string; invitation_body?: string; invitation_text?: string; rsvp_button_text?: string; sections?: ContentSection[]; }
...
export interface EventRsvp { id: string; event_id: string; guest_id: string | null; guest_name: string; status: "attending" | "declined" | "pending"; plus_ones: number; dietary: string; message: string; answers: Record<string, unknown> | null; submitted_at: string; }
export interface ScheduleItem { id: string; event_id: string; title: string; description: string | null; schedule_date: string | null; start_time: string | null; end_time: string | null; venue: string | null; address: string | null; dress_code: string | null; category: string | null; cover_image: string | null; order_index: number; created_at: string; }
